...
Pod::Spec.new do |s|
  ...
  #   * Finally, don't worry about the indent, CocoaPods strips it!
    ...
    s.description      = <<-DESC
  Lib shared to do unit test on j2objc apps
                         DESC
   ...
   #s.j2objc_home = "\"/opt/j2objc/lib\""
    ...
    s.homepage         = 'https://github.com/mobilemindtec/j2objc-unit'
    # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
    s.license          = { :type => 'MIT', :file => 'LICENSE' }
    s.author           = { 'Ricardo Bocchi' => 'ricardo@mobilemind.com.br' }
    s.source           = { :git => 'https://github.com/mobilemindtec/j2objc-unit.git', :tag => s.version.to_s }

    s.ios.deployment_target = "10.0"
    s.osx.deployment_target = "10.10"

    s.source_files = 'J2ObjCUnit/Classes/**/*'
    #s.source_files = '*.{h,m}'
